...
class RobotMove:
    ...
    def move(self, keys, dt, wall_list):
        ...
        if self.vr != 0 or self.vl != 0:
            ...
            # Computation of ICC
                ...
                u_col, b_col, r_col, l_col = self.is_colliding(wall_list)
    ...
    def is_colliding(self, wall_list):
        uper_col = False
        bottom_col = False
        right_col = False
        left_col = False
...
class Robot(object):
    ...
    def Main(self, weights):
        ...
        for _ in range(500):
            ...
            # run the robot
            activate = player_robot.move(key, dt, wall_list)
            ...
            enviroment.draw(SCREEN, images, player_robot, MAIN_FONT, HEIGHT)
            for wall in wall_list:
                wall.draw(SCREEN)
            ...
            cast_rays(SCREEN, walls, player_robot, ROBOT, STEP_ANGLE, SENSORS_FONT)
